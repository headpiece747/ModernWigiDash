...
public class DeviceTouchDrainTests
{
    ...
    private static MainWindow NewWindow(int pageCount)
    {
        ...
        return new MainWindow(new MainWindowTestOptions(new StubPresentMonNative(), path, new NoopPowerModeSource(), new FakeTraySurface(), UsbEngine: FakeTransport.InertEngine()));
    }
}
