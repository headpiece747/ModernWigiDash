      ...
      ocr_review: tool({
        ...
        async execute(args, context) {
          ...
          const result = await runOcr(buildReviewArgs({
            ...
            // The tool's timeoutMinutes is a whole-run budget, not per-file:
            // default 60 minutes so large workspace reviews don't hit the
            // plugin's hardcoded 15-minute cap mid-run.
