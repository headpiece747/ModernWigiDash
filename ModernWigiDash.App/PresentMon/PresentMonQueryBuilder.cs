...
internal sealed record PresentMonQuerySpec(DynamicField Field, uint MetricId, uint PreferredStat);
...
/// </summary>
internal sealed record PresentMonQueryBuildResult(
...
/// </summary>
internal static class PresentMonQueryBuilder
{
