...
public static class CalendarSeasonalPalettes
{
    ...
    [
        ...
        new(new SKColor(245, 200, 0), new SKColor(30, 41, 59), new SKColor(245, 200, 0), "APR", "April"),
        // May: Royal Indigo
        ...
        new(new SKColor(234, 168, 18), new SKColor(30, 41, 59), new SKColor(234, 168, 18), "OCT", "October"),
        // Nov: Electric Azure
