...
/// <summary>
/// The Hardware Monitor widget's display styles.
/// <see cref="SystemTelemetryDisplayModeParser.Parse"/> is the single
/// string→mode mapping site (the inspector property stays a string); unknown
/// values fall back to <see cref="SystemTelemetryDisplayMode.Gauge"/> — the
/// property default.
/// </summary>
internal enum SystemTelemetryDisplayMode
{
    Gauge,
    Bar,
    Value,
